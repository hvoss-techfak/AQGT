...
import scripts.utils.train_utils
...
class SpeechMotionDataset(Dataset):
    def __init__(self, lmdb_dir, n_poses, subdivision_stride, pose_resampling_fps, mean_pose, mean_dir_vec,
        ...
        self.expected_spectrogram_length = scripts.utils.data_utils.calc_spectrogram_length_from_motion_length(
    ...
    def get_data(self, idx):
        ...
        if do_clipping:
            ...
            audio = scripts.utils.data_utils.make_audio_fixed_length(audio, self.expected_audio_length)
